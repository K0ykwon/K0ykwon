    ...
    <main className="min-h-screen flex flex-col items-center justify-center gap-10">
      ...
      <div className="flex flex-col items-center">
        ...
        <h1 className="text-5xl font-light tracking-widest uppercase text-stone-800 dark:text-stone-100 transition-colors duration-300">
          Youngkwon{" "}
          <span className="inline-block leading-none bg-stone-800 text-white dark:bg-stone-100 dark:text-stone-900 px-1 py-[-0.2em]">/Ko</span>
        </h1>
      </div>
      ...
      <nav className="flex items-center gap-10">
        {navLinks.map((link) => (
          <a
            ...
            className="w-24 text-center text-xs tracking-[0.2em] uppercase text-stone-400 hover:text-stone-800 dark:hover:text-stone-100 transition-colors duration-200"
          >
            {link}
          </a>
        ))}
